    ...
    <div className="h-full flex flex-col items-center justify-center pb-4">
      <div className="w-full mt-2 rounded-xl flex flex-col px-2">
        <div className="flex-col">
          ...
          <div
            className={`border-b border-transparent dark:bg-dark-700 dark:bg-opacity-70 bg-light-400 rounded-xl  border ${inputToFocus ? '!border-purple-500 !border-purple-300/80 shadow-[0px_0px_10px_2px] shadow-purple-500/50' : ''}`}
          >
